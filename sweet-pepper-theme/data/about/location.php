<?php
/**
 * About data: Location — the description under the shared headline (data/location.php is
 * the headline). Fallback for sweet_pepper_about_location() and the seed source.
 *
 *   ru — from about-page-copy-ru-draft.md → 9. Адрес и вход
 *
