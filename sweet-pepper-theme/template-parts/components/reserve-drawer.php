...
<div class="reserve-drawer" id="reserve-drawer" role="dialog" aria-modal="true" aria-labelledby="reserve-title" aria-hidden="true" inert>
    ...
    <button type="button" class="reserve-drawer-close js-reserve-close" aria-label="Close drawer">
        <i class="ph ph-x"></i>
    </button>
    
    <div class="reserve-drawer-content">
        <div class="reserve-header">
            <h2 class="reserve-title" id="reserve-title">YOUR TABLE</h2>
            <!-- Subtitle text is updated by JS based on bar state -->
            <p class="reserve-subtitle">We're open — tonight, just walk in or write ahead.</p>
        </div>
        ...
        <div class="reserve-ticket-wrapper">
            ...
            <div class="reserve-ticket">
                <h3 class="ticket-title">STEAL THE LINE</h3>
                <p class="ticket-text" id="ticket-message">Hi! A table for two, tomorrow around 21:00 — doable?</p>
        ...
        <p class="reserve-footer-text">
            Walk-ins always welcome — booking matters Friday–Saturday evenings.
        </p>
    </div>
</div>
