<?php
/**
 * About data: Hero — as typed before the page moved into WordPress. Fallback for
 * sweet_pepper_about_hero() and the seed source. The filmstrip (labels, photos, anchors)
 * is structure and stays in the template.
 *
 *   ru — from about-page-copy-ru-draft.md → 1. Первый экран. The year is the draft's open
 *        {год}: 2014 as on the English side (Figma and the copy doc), to confirm.
 *
