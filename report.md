...
- **English still showing on the Russian page (not in the draft, found in the screenshots):** the Story eyebrow «SINCE 2014»; «YOUR MATCH» on the picker's ticket (the draft notes it has no Russian); the dish line «The legend of the Kirova street» under Жаркое — the «Гастробот» row's RU line. The counters still show placeholders (numbers pending the team).
