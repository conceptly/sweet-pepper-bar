...
return [
    ...
    'dayparts' => [
        'breakfast' => [
            ...
            'alt'      => 'Sweet Pepper breakfast plate',
            'headline' => 'YUMMY MORNING!',
            'body'     => 'Coffee, eggs and a good reason to get out of bed.',
            'button'   => 'Breakfast menu',
            'ru'       => [ 'headline' => 'ВКУСНОЕ УТРО!', 'body' => 'Кофе, яйца и хороший повод выбраться из-под одеяла.', 'button' => 'Меню завтраков' ],
        ],
        'lunch'     => [
            ...
            'button'   => 'Lunch menu',
            'ru'       => [ 'headline' => 'ВРЕМЯ ТЫКВЕННОГО СУПА!', 'body' => 'Тыквенный суп, что-нибудь сытное — и пусть дела немного подождут.', 'button' => 'Обеденное меню' ],
        ],
        'dinner'    => [
            ...
            'button'   => 'Dinner menu',
            'ru'       => [ 'headline' => 'ПЛАНЫ НА ВЕЧЕР?', 'body' => 'Начните с ужина. А там, глядишь, и на коктейль останетесь.', 'button' => 'Меню ужина' ],
        ],
        'party'     => [
            ...
            'button'   => 'Drinks menu',
            'ru'       => [ 'headline' => 'ВРЕМЯ КОКТЕЙЛЕЙ!', 'body' => 'Начните с любимого коктейля. А дальше — как пойдёт.', 'button' => 'Барное меню' ],
        ],
    ],
